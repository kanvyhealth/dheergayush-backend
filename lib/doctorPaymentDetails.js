...
function parseDoctorSelfServiceProfile(body = {}) {
  ...
  delete profile.consultationFee;
  delete profile.consultation_fee;
  delete profile.pendingConsultationFee;
  delete profile.pendingFeeRequestedAt;
  delete profile.pendingFeePreviousFee;
  delete profile.pendingFeeApprovedAt;
  delete profile.pendingFeeRejectedAt;
