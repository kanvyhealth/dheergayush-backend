...
const { getEffectiveStatus, workingToPresenceValue, getDoctorPresenceStatus } = require('../modules/doctors/doctorAvailability');
const { updateDoctorPresence, isDoctorBusy, findDoctorByName } = require('../modules/doctors/doctorPresence');
